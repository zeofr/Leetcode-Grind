...
Main Concepts : DATE manipulation & Handling 

Solved using : DATE_SUB(), DATE_ADD()

So this question asked me to list id of days which are hotter than last day, for this I used `LEFT JOIN` on `Weather` twice. 
